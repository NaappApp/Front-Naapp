    ...
    <div className="forms-page-container">
      ...
      <div className="forms-container">
        ...
        <div
          ...
          <label htmlFor="Professionel">Professionel</label>
          <input
            type="radio"
            id="NEUROATYPIQUE"
            name="role"
            ...
            className="role"
          />
          <label htmlFor="NEUROATYPIQUE">NEUROATYPIQUE</label>
          <input type="radio" id="Curieux" name="role" value="Curieux" className="role" />
          <label htmlFor="Curieux">Curieux</label>
        </div>
        <div className="button-container">
          <button type="submit" className="button" onClick={() => props.saveRole(role)}>
            Suivant
          </button>
        </div>
      </div>
