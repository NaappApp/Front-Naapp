    ...
    return (
        <nav className="pl-16">
            <ul className="h-full flex justify-center content-center">
                <li className="px-2">
                    <a className="" href="/">
                        <div className={isActive ? "flex justify-center content-center bg-gray-100 px-2 py-1 rounded-full mb-2" : "flex justify-center content-center py-1 bg-gray-100 px-2"}>
